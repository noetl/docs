...
- Latest local kind validation for `noetl/noetl#435`: image `local/noetl:2026-05-16-22-01`, health/replay/pod/log smokes passed, in-pod Arrow IPC TempStore round-trip passed, and in-pod cursor-worker frame capture produced two Arrow-backed frames from three claimed rows.
